...
public class OntConfigs {
    ...
    public static final OntConfig OWL2_CONFIG = OntConfig.DEFAULT
            ...
            .setTrue(OntModelConfig.USE_OWL_DISJOINT_WITH_FEATURE)
            .setTrue(OntModelConfig.USE_OWL_EQUIVALENT_CLASS_FEATURE);
    ...
    public static final OntConfig OWL1_LITE_CONFIG = OntConfig.DEFAULT
            ...
            .setFalse(OntModelConfig.USE_OWL2_CLASS_HAS_KEY_FEATURE)
            .setFalse(OntModelConfig.USE_OWL2_CLASS_DISJOINT_UNION_FEATURE)
            .setFalse(OntModelConfig.USE_OWL_DISJOINT_WITH_FEATURE)
            .setTrue(OntModelConfig.USE_OWL_EQUIVALENT_CLASS_FEATURE);
    ...
    public static final OntConfig RDFS_CONFIG = OntConfig.DEFAULT
            ...
            .setFalse(OntModelConfig.USE_OWL2_CLASS_DISJOINT_UNION_FEATURE)
            .setFalse(OntModelConfig.USE_OWL_DISJOINT_WITH_FEATURE)
            .setFalse(OntModelConfig.USE_OWL_EQUIVALENT_CLASS_FEATURE);
}

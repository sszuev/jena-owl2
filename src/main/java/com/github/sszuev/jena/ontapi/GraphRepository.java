...
public interface GraphRepository {
     ...
     * specified by the method {@link DocumentGraphRepository#addMapping(String, String)}.
     *
    ...
    static DocumentGraphRepository createGraphDocumentRepository(Supplier<Graph> factory) {
        return new DocumentGraphRepository(factory == null ? GraphMemFactory::createDefaultGraph : factory);
    }

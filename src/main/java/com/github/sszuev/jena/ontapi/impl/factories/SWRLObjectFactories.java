...
public final class SWRLObjectFactories {
    ...
    public static final EnhNodeFactory DARG_SWRL = OntEnhNodeFactories.createCommon(
            ...
            OntSWRLImpl.VARIABLE_FILTER.or(LiteralImpl.factory::canWrap)
    );
    public static final EnhNodeFactory IARG_SWRL = OntEnhNodeFactories.createCommon(
            OntSWRLImpl.IArgImpl.class,
            EnhNodeFinder.ANY_SUBJECT_AND_OBJECT,
            OntSWRLImpl.VARIABLE_FILTER.or((n, g) -> OntEnhGraph.canAs(OntIndividual.class, n, g))
    );
    public static final EnhNodeFactory BUILTIN_SWRL = OntEnhNodeFactories.createCommon(
            ...
            OntSWRLImpl.BUILTIN_FILTER
    );
    public static final EnhNodeFactory BUILT_IN_ATOM_SWRL = OntSWRLImpl.makeAtomFactory(
            OntSWRLImpl.BuiltInAtomImpl.class,
            SWRL.BuiltinAtom
    );
    public static final EnhNodeFactory CLASS_ATOM_SWRL = OntSWRLImpl.makeAtomFactory(
            OntSWRLImpl.OntClassAtomImpl.class,
            SWRL.ClassAtom
    );
    public static final EnhNodeFactory DATA_RANGE_ATOM_SWRL = OntSWRLImpl.makeAtomFactory(
            OntSWRLImpl.DataRangeAtomImpl.class,
            SWRL.DataRangeAtom
    );
    public static final EnhNodeFactory DATA_VALUED_ATOM_SWRL = OntSWRLImpl.makeAtomFactory(
            OntSWRLImpl.DataPropertyAtomImpl.class,
            SWRL.DatavaluedPropertyAtom
    );
    public static final EnhNodeFactory INDIVIDUAL_ATOM_SWRL = OntSWRLImpl.makeAtomFactory(
            OntSWRLImpl.ObjectPropertyAtomImpl.class,
            SWRL.IndividualPropertyAtom
    );
    public static final EnhNodeFactory DIFFERENT_INDIVIDUALS_ATOM_SWRL = OntSWRLImpl.makeAtomFactory(
            OntSWRLImpl.DifferentIndividualsAtomImpl.class,
            SWRL.DifferentIndividualsAtom
    );
    public static final EnhNodeFactory SAME_INDIVIDUALS_ATOM_SWRL = OntSWRLImpl.makeAtomFactory(
            OntSWRLImpl.SameIndividualsAtomImpl.class,
            SWRL.SameIndividualAtom
    );
    public static final EnhNodeFactory IMPL_SWRL = new OntSWRLImpl.SWRLImplFactory();
